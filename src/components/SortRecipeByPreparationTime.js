...
const SortRecipeByPreparationTime = () => {
  ...
  useEffect(() => {
    const fetchLatestRecipes = async () => {
      try {
        ...
        const response = await httpService.get(`${API_HOST}/recipes?sort=preparationTime`, null);
...
export default SortRecipeByPreparationTime;
